...
-- Use a CTE to calculate the median salary by title and work arrangement, then compute those medians.
...
-- Need to find jobs in jpf where skills_id does not exist in jpf
-- WHERE NOT EXISTS if you are creating a table of jobs with no associated skills
-- WHERE EXISTS if you are creating a table of jobs with associated skills
